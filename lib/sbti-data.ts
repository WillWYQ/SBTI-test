...
export const questions: RegularQuestion[] = [
  {
    id: "q1",
    dim: "S1",
...
export const specialQuestions: [SpecialQuestion, SpecialQuestion] = [
  {
    id: "drink_gate_q1",
    special: true,
    kind: "drink_gate",
...
export const DIM_EXPLANATIONS: Record<DimensionKey, Record<"L" | "M" | "H", string>> = {
  S1: {
